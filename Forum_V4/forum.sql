...
--
-- Client :  localhost
-- Généré le :  Mar 20 Janvier 2015 à 20:35
...
--
-- Structures pour les tables exportées
--
...
--
ALTER TABLE `reponse`
 ADD PRIMARY KEY (`idRep`), ADD KEY `index_idSujetRep` (`idSujet`) COMMENT 'index sur fk idSujet de la table reponse', ADD KEY `index_idUserRep` (`idUser`) COMMENT 'index sur fk idUser de la table reponse';
...
(5, 'titi', 'titi', '5d933eef19aee7da192608de61b6c23d', NULL, 1, 'image/885c4e273b3d7752dad8b89d047dabaf.jpg', 3),
...
(1, 'Faire le php!', '0000-00-00', '<p>Nous allons commencer par les bases de PHP. Pour effectuer ce cours, nous aurons besoin de Wamp ou Lamp ou Mamp...</p>', 0, 0, 1, 1),
(2, 'Apprendre le php', '0000-00-00', '<p>Nous allons commencer par les bases de PHP. Pour effectuer ce cours, nous aurons besoin de Wamp ou Lamp ou Mamp...</p>', 0, 0, 1, 1),
(3, 'Apprendre l''HTML', '0000-00-00', '<p>Nous allons commencer par les bases de PHP. Pour effectuer ce cours, nous aurons besoin de Wamp ou Lamp ou Mamp...</p>', 0, 0, 1, 1),
(4, 'Apprendre le TCP/IP', '0000-00-00', 'Nous allons commencer par expliquer ces deux protocoles ...', 0, 0, 1, 2),
(8, 'Apprendre l''algorithmie', '2015-01-05', '<p>Ceci est un test de cr&eacute;ation de sujet bidon</p>', 0, 0, 4, 3);
...
(1, '0000-00-00', '<p>Il nous manque la suite</p>', 0, 1, 2),
(2, '2015-01-12', '<p>Si tu veux mon avis &ccedil;a va &ecirc;tre compliqu&eacute; :)</p>', 1, 5, 1),
(3, '2015-01-12', '<p><em>Je ne pense <strong>pas</strong> :p </em></p>', 1, 4, 1);
